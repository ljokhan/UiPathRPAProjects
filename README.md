...
When changes are completed, I commit and push the changes to my DEV branch.

After creating a new pull request, I approve it and merge it with the MAIN branch.
